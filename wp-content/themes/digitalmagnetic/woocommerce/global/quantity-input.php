...
if ( $max_value && $min_value === $max_value ) {
	...
	$labelledby = ! empty( $args['product_name'] ) ? sprintf( __( '%s quantity', 'wavee' ), strip_tags( $args['product_name'] ) ) : '';
	?>
	<div class="product-qty">
        ...
        <input
			...
			title="<?php echo esc_attr_x( 'Qty', 'Product quantity input tooltip', 'wavee' ); ?>"
			size="4"
