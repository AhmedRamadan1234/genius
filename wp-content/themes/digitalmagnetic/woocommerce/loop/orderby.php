...
<div class="col-lg-6 col-md-7">
    <div class="shop_menu_right d-flex align-items-center justify-content-end">
        <?php if ($permalink != '/%plain%/' ) : ?>
            <div class="view-style shop_grid <?php echo esc_attr($layout) ?>">
                <div class="list-style <?php echo esc_attr($is_grid_active); ?>">
                    <a href="<?php echo esc_url($current_url); ?>?view=grid">
                        <i class="ti-layout-grid2"></i>
                    </a>
                </div>
                <div class="grid-style <?php echo esc_attr($is_list_active); ?>">
                    <a href="<?php echo esc_url($current_url); ?>?view=list">
        ...
        <div class="default_select">
            <h5><?php esc_html_e( 'Sort by', 'wavee' ) ?></h5>

            <form class="woocommerce-ordering wavee_select" method="get">
