...
if ( !isset( $opt['shop_sidebar'] ) ) {
    $is_sidebar = ( is_active_sidebar( 'shop_sidebar') ) ? '9' : '12';
}else {
    $is_sidebar = ( $shop_sidebar == 'left' || $shop_sidebar == 'right' ) ? '9' : '12';
}
...
?>
    ...
    <div class="row <?php echo esc_attr($is_sidebar_switch) ?>">
        <div class="col-lg-<?php echo esc_attr($is_sidebar) ?>">
            <?php
            if ( is_active_sidebar( 'shop_sidebar' )) {
                if (woocommerce_product_loop()) {
                    echo '<div class="shop_tab">';
            ...
            <div class="<?php echo esc_attr( $is_grid_active ) ?>">
                <?php
                if ( woocommerce_product_loop() ) {
